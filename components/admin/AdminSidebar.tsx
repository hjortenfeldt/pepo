...
const NAV: NavItem[] = [
  ...
  { href: "/categories", label: "Kategorier", icon: "tags", active: true },
...
export default function AdminSidebar({
  ...
  return (
    <div className="w-56 bg-pepo-wh border-r border-pepo-bd flex-shrink-0 flex flex-col p-3.5">
      <div className="flex items-center gap-2.5 px-2 pt-1.5 pb-5">
        ...
        <span className="text-[15px] font-semibold tracking-tight text-pepo-t1">
      ...
      <div className="mt-auto pt-2.5 border-t border-pepo-bd flex items-center gap-2.5 px-2.5">
