...
import ShareIosIcon from "@/components/freelancer/ShareIosIcon";

// Kun mobile platforme — AdminInstallGate.tsx viser aldrig denne guide på
// desktop overhovedet (se lib/device-detection.ts), i modsætning til
// freelancer-appens InstallGuide.tsx som også har desktop-varianter.
export type Platform = "ios-safari" | "ios-other" | "android-chrome" | "android-samsung" | "android-other";
...
const CLOSING_STEP = "Luk derefter denne side og åbn Admin Appen via app-ikonet på din hjemmeskærm.";
...
const CONTENT: Record<Platform, GuideContent> = {
  "ios-safari": {
    heading: "Sådan installerer du Admin Appen på din iPhone",
    steps: [
  ...
  "ios-other": {
    heading: "Sådan installerer du Admin Appen",
  ...
  "android-chrome": {
    heading: "Sådan installerer du Admin Appen på din Android-telefon",
    steps: [
        ...
        {step === "confirming" ? (
          <>
            <div className="text-[15px] text-pepo-t1 leading-snug">
              Hvis du bruger Admin Appen i din browser i stedet for at installere den, får du ikke
              fuldskærmsvisning eller notifikationer, når det bliver relevant. Er du sikker på at du vil
              fortsætte i browseren, uden at installere appen?
            </div>
          ...
          <>
            <div className="text-[15px] text-pepo-t1 leading-snug">
              Du kan når som helst installere Admin Appen ved at gå til din profil og trykke
              &quot;Installér Admin Appen&quot;.
            </div>
            <button
              type="button"
              onClick={onDone}
    ...
    <div className="min-h-dvh flex flex-col bg-pepo-su relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-10 text-center">
        <div className="mb-8">
          ...
          <img src="/pepo-admin-logo.svg" alt="Pepo Admin" className="w-[120px] h-[120px] flex-shrink-0" />
        </div>
