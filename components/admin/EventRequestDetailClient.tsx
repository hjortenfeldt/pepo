...
import {
  ...
  acceptEventRequest,
  uploadEventMessageAttachmentAsAdmin,
  ...
  return (
    <div className="px-[var(--page-px)] py-[22px] pb-16 max-w-[720px]">
      ...
      <CorrespondenceThread
        ...
        onSend={(body, attachments) => replyAsAdmin(request.id, body, attachments)}
        onUploadAttachment={(file) => uploadEventMessageAttachmentAsAdmin(request.id, file)}
      />
    </div>
  );
}
