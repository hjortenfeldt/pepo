...
export default function SuperAdminLoginForm({ initialError }: { initialError: string | null }) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5 mb-7">
        <div className="w-10 h-10 rounded-[10px] bg-pepo-t1 flex items-center justify-center">
      ...
      <div className="mb-5">
        ...
        <div className="text-sm text-pepo-t2 mt-1">Kun for Pepos eget team</div>
      </div>
      ...
      <div className="mb-5">
        <label className="block text-[13px] font-medium text-pepo-t1 mb-[5px]">Adgangskode</label>
        <input
          type="password"
          name="password"
          required
      ...
      <button
        type="submit"
        disabled={isPending}
        className="w-full h-[46px] rounded-[10px] text-[15px] font-medium bg-pepo-t1 text-white transition-opacity hover:opacity-90 disabled:opacity-40"
      >
