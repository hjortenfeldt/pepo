...
export default async function AdminShiftsPage() {
  ...
  const [eventsResult, clientsResult, categoriesResult, freelancersResult] = await Promise.all([
    ...
    supabase
      ...
      .select("id, full_name, freelancer_categories(work_categories(name))")
  ...
  const freelancers: FreelancerOption[] = ((freelancersResult.data ?? []) as RawFreelancerOptionRow[]).map((f) => {
